...
/**
 * Developer menu — the debug/authoring controls (gem & EXP grants, the Level
 * Designer, account reset). Formerly the whole Settings modal; now reached from
 * the player-facing Settings menu so those tools stay out of the way.
 */
